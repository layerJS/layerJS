# layerJS Individual Contributor Assignment Agreement #
     Harmony (HA-CAA-I-ANY) Version 1.0 [http://harmonyagreements.org]

Thank you for your interest in contributing to layerJS ("We" or "Us").
This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by mail, following the instructions at . This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
...
(d) You have informed us, if You do not own the Copyright in the entire work of authorship Submitted.
## 4. Disclaimer ##
