...
```
<script src="http://cdn.layerjs.org/libs/layerjs/layerjs-0.4.2.js"></script>
<link href="http://cdn.layerjs.org/libs/layerjs/layerjs-0.4.2.css" type="text/css" rel="stylesheet" />
```
